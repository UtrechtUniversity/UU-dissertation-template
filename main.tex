...
%%%% Dedication (opt)
%% - can be used to thank someone or display a significant quotation.
%% - an empty & clear page should be used
\clearpage
\thispagestyle{empty}
...
\part[\color{thumb\arabic{thumbcounter}}
\label{part:second}
...
%% Temporary filler
\chapter{A filler chapter}\label{chap:profile1}
\lipsum[15-29]

%% Temporary filler
\chapter{Some filler chapter}\label{chap:profile2}
\lipsum[30-41]
And a final line.
...
%%
%% - Paper 4: More filler chapters
%% - Paper 5: A final filling
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Name and label
\part[An example of another part]{An example of another part}
\label{part:second}
...
%% Temporary filler
\chapter{More filler chapters}\label{chap:profile3}
\lipsum[45-52]

%% Temporary filler
\chapter{Some filler chapter}\label{chap:profile4}
\lipsum[53-68]
And a very final line.
