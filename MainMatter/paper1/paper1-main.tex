...
The corporate colors of the Utrecht University are red, black and yellow, available, respectively, via \texttt{\textbackslash color\{{\color{utrechtuniversity-red}utrechtuniversity-red}\}}, \texttt{\textbackslash color\{{\color{utrechtuniversity-black}utrechtuniversity-black}\}} (which differs slightly from the default \texttt{black}) and \texttt{\textbackslash color\{utrechtuniversity-yellow\}}. Apart from these three, the house style defines the basic colors
\begin{itemize}
%% Reduce the separation between the items, since this is just a list of words.
\itemsep 0pt
\parskip 0pt
\item\texttt{\color{utrechtuniversity-creme}utrechtuniversity-creme},
\item\texttt{\color{utrechtuniversity-orange}utrechtuniversity-orange},
\item\texttt{\color{utrechtuniversity-bordeaux}utrechtuniversity-bordeaux},
\item\texttt{\color{utrechtuniversity-brown}utrechtuniversity-brown},
\item\texttt{\color{utrechtuniversity-green}utrechtuniversity-green},
\item\texttt{\color{utrechtuniversity-blue}utrechtuniversity-blue},
\item\texttt{\color{utrechtuniversity-darkblue}utrechtuniversity-darkblue} and
\item\texttt{\color{utrechtuniversity-purple}utrechtuniversity-purple} 
\end{itemize}